<?php
  ...
  * Slug: fse-sports-arena/404-header-with-background
  */
?>
...
<p class="has-text-align-center has-foreground-color has-text-color has-content-heading-font-size"><?php esc_html_e('Oops! That page cannot be found','fse-sports-arena'); ?></p>
<!-- /wp:paragraph -->
